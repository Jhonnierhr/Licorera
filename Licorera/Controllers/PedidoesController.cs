...
namespace Licorera.Controllers
{
    public class PedidoesController : Controller
    {
        ...
        {
            var gestionNegocioContext = _context.Pedidos.Include(p => p.Cliente);
        ...
        public async Task<IActionResult> Create([Bind("PedidoId,ClienteId,Fecha,Total,Estado")] Pedido pedido)
        {
