...
namespace Licorera.Controllers
{
    public class ProveedoresController : Controller
    {
        ...
        public ProveedoresController(GestionNegocioContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("ProveedorId,Nombre,Email,Telefono,Direccion,CreatedAt,UpdatedAt")] Proveedore proveedore)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ProveedorId,Nombre,Email,Telefono,Direccion,CreatedAt,UpdatedAt")] Proveedore proveedore)
        {
